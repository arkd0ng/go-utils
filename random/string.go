...
// Parameters
// 매개변수:
// - length: variable arguments for length specification
// 길이 지정을 위한 가변 인자
// * 1 argument: fixed length
// 1개 인자: 고정 길이
// Example: Letters(10) generates a 10-character string
// Letters(10)은 10자 문자열 생성
// * 2 arguments: min and max length
// 2개 인자: 최소 및 최대 길이
// Example: Letters(8, 12) generates 8-12 character string
// Letters(8, 12)는 8-12자 문자열 생성
//
// Returns
// 반환값:
// - string: generated random string
// 생성된 랜덤 문자열
// - error: error if invalid parameters
// 잘못된 매개변수인 경우 에러
...
// - Hash values
// 해시값
// - Lowercase hexadecimal identifiers
// 소문자 16진수 식별자
...
// * 1 argument: fixed length
// 1개 인자: 고정 길이
// Example: Base64URL(64) generates a 64-character string
// Base64URL(64)은 64자 문자열 생성
// * 2 arguments: min and max length
// 2개 인자: 최소 및 최대 길이
// Example: Base64URL(64, 128) generates 64-128 character string
// Base64URL(64, 128)은 64-128자 문자열 생성
//
// Returns
// 반환값:
// - string: generated random string
