...
//
// Parameters / 매개변수:
//   - appName: application name / 애플리케이션 이름
//   - version: version string / 버전 문자열
//
// Example / 예제:
//
...
func (l *Logger) Banner(appName, version string) {
	...
	// Print banner using Info level / INFO 레벨로 배너 출력
...
//
// Parameters / 매개변수:
//   - lines: array of banner lines / 배너 줄의 배열
//
// Example / 예제:
//
...
//   - appName: application name / 애플리케이션 이름
//   - version: version string / 버전 문자열
//   - description: optional description / 선택적 설명
//
// Example / 예제:
//
...
func (l *Logger) DoubleBanner(appName, version, description string) {
	...
	// Second text line if description provided / 설명이 제공된 경우 두 번째 텍스트 줄
	if description != "" {
...
//
// Parameters / 매개변수:
//   - char: character to use for the line / 줄에 사용할 문자
//   - width: width of the line / 줄의 너비
//
// Example / 예제:
//
