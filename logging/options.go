...
type config struct {
	// Lumberjack file rotation settings / Lumberjack 파일 로테이션 설정
...
//
// Parameters / 매개변수:
//   - mb: maximum size in megabytes / 메가바이트 단위 최대 크기
//
// Example / 예제:
//
...
//
// Parameters / 매개변수:
//   - n: maximum number of backups / 백업의 최대 개수
//
// Example / 예제:
//
...
//
// Parameters / 매개변수:
//   - days: maximum age in days / 일 단위 최대 보관 기간
//
// Example / 예제:
//
//	logger, _ := logging.New(logging.WithMaxAge(7)) // Keep for 7 days / 7일 동안 보관
...
//
// Parameters / 매개변수:
//   - compress: true to enable compression / 압축을 활성화하려면 true
//
// Example / 예제:
//
...
//
// Parameters / 매개변수:
//   - level: minimum log level / 최소 로그 레벨
//
// Example / 예제:
//
...
//
// Parameters / 매개변수:
//   - enable: true to enable color / 색상을 활성화하려면 true
//
// Example / 예제:
//
...
//
// Parameters / 매개변수:
//   - enable: true to enable stdout / 표준 출력을 활성화하려면 true
//
// Example / 예제:
//
...
//
// Parameters / 매개변수:
//   - enable: true to enable file output / 파일 출력을 활성화하려면 true
//
// Example / 예제:
//
...
//
// Parameters / 매개변수:
//   - format: time format string (Go time format) / 시간 형식 문자열 (Go 시간 형식)
//
// Example / 예제:
//
