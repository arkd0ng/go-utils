...
func TestAppYamlIntegration(t *testing.T) {
	...
	// Should contain "v1.2.004" (version from cfg/app.yaml)
	if !strings.Contains(logStr, "v1.2.004") {
		t.Error("Log file should contain version 'v1.2.004' from cfg/app.yaml")
	}
}
