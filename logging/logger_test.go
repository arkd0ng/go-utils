...
func TestAppYamlIntegration(t *testing.T) {
	...
	// Should contain "v1.4.017" (version from cfg/app.yaml)
	if !strings.Contains(logStr, "v1.4.017") {
		t.Error("Log file should contain version 'v1.4.017' from cfg/app.yaml")
	}
}
