...
// TestNewSessionStore tests creating a new session store
// 새 세션 저장소 생성 테스트
...
// TestSessionStoreNew tests creating a new session
// 새 세션 생성 테스트
...
// TestSessionSetGet tests session set and get operations
// 세션 설정 및 가져오기 작업 테스트
...
// TestSessionGetTyped tests typed getter methods
// 타입별 getter 메서드 테스트
...
// TestSessionDelete tests deleting session values
// 세션 값 삭제 테스트
...
// TestSessionClear tests clearing all session values
// 모든 세션 값 지우기 테스트
...
// TestSessionStoreGetExisting tests getting an existing session from cookie
// 쿠키에서 기존 세션 가져오기 테스트
...
// TestSessionStoreGetNew tests creating a new session when none exists
// 세션이 없을 때 새 세션 생성 테스트
...
// TestSessionStoreSave tests saving a session and setting cookie
// 세션 저장 및 쿠키 설정 테스트
...
// TestSessionStoreDestroy tests destroying a session
// 세션 파괴 테스트
...
// TestSessionConcurrency tests concurrent access to session
// 세션에 대한 동시 액세스 테스트
...
// BenchmarkSessionSet benchmarks session Set operation
// 세션 Set 작업 벤치마크
...
// BenchmarkSessionGet benchmarks session Get operation
// 세션 Get 작업 벤치마크
...
// BenchmarkSessionStoreNew benchmarks creating new sessions
// 새 세션 생성 벤치마크
