...
func main() {
	...
	// 예제 1: 알파벳만
	fmt.Println("1. Alphabetic only (8-12 characters) / 알파벳만 (8-12자):")
	...
	// 예제 4: 특수 문자 포함
	fmt.Println("4. With all special characters (16-24 characters) / 모든 특수 문자 포함 (16-24자):")
	str4 := random.GenString.AlphaNumSpecial(16, 24)
	fmt.Printf("   Result / 결과: %s (length / 길이: %d)\n\n", str4, len(str4))

	// Example 5: With limited special characters
	// 예제 5: 제한된 특수 문자 포함
	fmt.Println("5. With limited special characters (20-30 characters) / 제한된 특수 문자 포함 (20-30자):")
